        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HospitalMainPhoneNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    HospitalMainPhoneLabel = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DepartmentId = table.Column<int>(type: "int", nullable: false),
                    PersonnelShiftStart = table.Column<DateTime>(type: "datetime2(0)", precision: 0, nullable: false),
                    PersonnelShiftEnd = table.Column<DateTime>(type: "datetime2(0)", precision: 0, nullable: false),
                    PersonnelGender = table.Column<byte>(type: "tinyint", nullable: false, defaultValue: (byte)0),
                    PersonnelPhoneNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    PersonnelPhoneLabel = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    PersonnelEmailAddress = table.Column<string>(type: "nvarchar(254)", maxLength: 254, nullable: false),
